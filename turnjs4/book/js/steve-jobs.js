...
function fun(val){
	...
	fetch('./data.json')
    	...
    	.then((json) => {
		document.getElementById('pic1').setAttribute("src", json[val.value-1].images[0])
		document.getElementById('pic2').setAttribute("src", json[val.value-1].images[1])
		}
	);	
}

function fun1(){
	if (localStorage.getItem("text" + document.getElementById('locSelect').value) == null)
		localStorage.setItem("text" + document.getElementById('locSelect').value, document.getElementById('describe').value);
		//document.getElementById('describe').value = localStorage.getItem("text" + document.getElementById('locSelect').value);
	else
		localStorage.setItem("text" + document.getElementById('locSelect').value + "n", document.getElementById('describe').value);
}

//THIS IS THE FUNCTION THAT GETS THE KEY PRESS
